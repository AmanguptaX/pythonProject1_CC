...
def issue_book(book_title, borrower_name, issue_date, due_date):
    ...
    c.execute(
        '''CREATE TABLE IF NOT EXISTS BookIssueTable (id INTEGER PRIMARY KEY AUTOINCREMENT, book_id INTEGER, borrower_name TEXT, issue_date TEXT, due_date TEXT)''')
...
def main():
    ...
    menu = ["Add Book", "View Books", "Search Books", 'Delete Book', 'Borrower Registration', 'View Borrowers',
            'Issue Book']
